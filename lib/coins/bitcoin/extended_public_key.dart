...
class ExtendedPublicKey {
  ...
  ExtendedPublicKey({required this.node, required this.magicVersion});

  Future<String> getKey() async {
    final String? key = await CryptoPlugin.getHDNodeXpub(node,
        curve: "secp256k1", version: this.magicVersion);
    if (key == null) {
