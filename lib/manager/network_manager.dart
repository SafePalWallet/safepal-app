...
final Options urlEncodeFormOptions = Options(
    contentType:
        ContentType.parse("application/x-www-form-urlencoded").toString());
final Options jsonOptions =
    Options(contentType: ContentType.parse("application/json").toString());
final Options multipartFormData =
    Options(contentType: ContentType.parse("multipart/form-data").toString());
...
abstract class SFError extends Error {
  ...
  static List<ApiErrorType> _timeouts = [
    ApiErrorType.CONNECT_TIMEOUT,
    ApiErrorType.RECEIVE_TIMEOUT,
    ApiErrorType.SEND_TIMEOUT
  ];
...
class SFNetworkError extends SFError {
  ...
  SFNetworkError({ApiErrorType? type, this.message}) : super(type: type);
...
class ApiResp {
  ...
  ApiResp({this.data, this.message, this.srcResp, this.error});
...
enum _HTTPMethod { get, post, put, delete, head }
...
class NetworkManager {
  ...
  static NetworkManager newManager(String url, Wallet? wallet,
      {int? connectTimeout}) {
  ...
  Future<ApiResp> get(
      ...
      String? client,
      String? headerSandbox}) async {
    return await _req(_HTTPMethod.get,
        path: path,
  ...
  Future<ApiResp> post(
      ...
      String? client,
      String? headerSandbox}) async {
    return await _req(_HTTPMethod.post,
        path: path,
        queryParas: queryParas,
        data: data,
        options: options,
  ...
  Future<ApiResp> put({
    ...
    return await _req(_HTTPMethod.put,
        path: path,
        queryParas: queryParas,
        data: data,
        options: options,
  ...
  Future<ApiResp> delete(
      ...
      String? headerSandbox,
      String? client}) async {
    return await _req(_HTTPMethod.delete,
        path: path,
        queryParas: queryParas,
        data: data,
        options: options,
  ...
  Future<ApiResp> head({
    ...
    return await _req(_HTTPMethod.head,
        path: path,
        queryParas: queryParas,
        data: data,
        options: options,
    ...
    try {
      ...
      switch (method) {
        case _HTTPMethod.put:
          response = await dio.put(_subPath,
        ...
        case _HTTPMethod.delete:
          response = await dio.delete(_subPath,
              queryParameters: queryParas,
              options: options,
              data: data,
              cancelToken: cancelToken);
        ...
        case _HTTPMethod.get:
          response = await dio.get(_subPath,
              queryParameters: queryParas,
              options: options,
              cancelToken: cancelToken);
          break;
        case _HTTPMethod.post:
          response = await dio.post(_subPath,
              queryParameters: queryParas,
              options: options,
              data: data,
              cancelToken: cancelToken);
        ...
        case _HTTPMethod.head:
          response = await dio.head(_subPath,
              queryParameters: queryParas,
              options: options,
              data: data,
              cancelToken: cancelToken);
      ...
      SFNetworkError networkError =
          SFNetworkError(type: ApiErrorType.RESPONSE, message: e.toString());
  ...
  ApiResp _resp(String? path, Response response) {
    ...
    return ApiResp(data: respData, srcResp: response);
  }
  ...
  SFError _assureError(DioError e) {
    if (e.response != null || e.type == DioErrorType.response) {
      ...
      return SFNetworkError(type: errorType, message: e.message);
    }
  }
}
