...
void ge25519_double_scalarmult_vartime(ge25519 *r, const ge25519 *p1, const bignum256modm s1, const bignum256modm s2) {
	...
	ge25519_pniels pre1[S1_TABLE_SIZE] = {{{0},{0},{0},{0}}};
#ifdef ED25519_NO_PRECOMP
...
void ge25519_scalarmult(ge25519 *r, const ge25519 *p1, const bignum256modm s1) {
	...
	ge25519_pniels pre1[9] = {{{0},{0},{0},{0}}};
	ge25519_pniels pre = {{0},{0},{0},{0}};
	ge25519 d1 = {{0},{0},{0},{0}};
	ge25519_p1p1 t = {{0},{0},{0},{0}};
	int32_t i = 0;
...
void ge25519_add(ge25519 *r, const ge25519 *p, const ge25519 *q, unsigned char signbit) {
	ge25519_pniels P_ni = {{0},{0},{0},{0}};
	ge25519_p1p1 P_11 = {{0},{0},{0},{0}};
