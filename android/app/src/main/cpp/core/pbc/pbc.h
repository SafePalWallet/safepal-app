...
uint32_t pbc_rmessage_uint32(struct pbc_rmessage * , const char *key , int index);
uint64_t pbc_rmessage_uint64(struct pbc_rmessage * , const char *key , int index);

uint32_t pbc_read_uint32(struct pbc_rmessage * , const char *key);
uint64_t pbc_read_uint64(struct pbc_rmessage * , const char *key);
...
const char * pbc_read_string(struct pbc_rmessage * , const char *key);
const char * pbc_read_bytes(struct pbc_rmessage * , const char *key ,int *sz);
struct pbc_rmessage * pbc_rmessage_message(struct pbc_rmessage *, const char *key, int index);
struct pbc_rmessage * pbc_read_message(struct pbc_rmessage *, const char *key);
...
int pbc_wmessage_uint32(struct pbc_wmessage *, const char *key, uint32_t n);
int pbc_wmessage_uint64(struct pbc_wmessage *, const char *key, uint64_t n);
